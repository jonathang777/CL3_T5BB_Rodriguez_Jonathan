...
public class ObjListaSERVICIO implements Serializable, Parcelable {
    ...
    public final static Creator<ObjListaSERVICIO> CREATOR = new Creator<ObjListaSERVICIO>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ObjListaSERVICIO createFromParcel(Parcel in) {
            return new ObjListaSERVICIO(in);
        }

        public ObjListaSERVICIO[] newArray(int size) {
            return (new ObjListaSERVICIO[size]);
        }
    ...
    protected ObjListaSERVICIO(Parcel in) {
